...
var STRINGS = {
  es: {
    ...
    "proximo.eyebrow": "El próximo paso",
    "proximo.title": "Objetivo a 12 meses: constituir la empresa y firmar el primer contrato",
    "proximo.p1t": "Consolidar la empresa",
    "proximo.p1d": "Constituir AtomIA y dotarla de la estructura legal, administrativa y de infraestructura para operar.",
    "proximo.p2t": "Fortalecer el equipo",
    "proximo.p2d": "Reforzar capacidades comerciales y de gestión.",
    "proximo.p3t": "Misiones comerciales",
    "proximo.p3d": "Visitar al menos 7 centrales: Argentina, Brasil, Rumania y otras. Participar en eventos científicos de primera línea.",
  ...
  en: {
    ...
    "proximo.eyebrow": "The next step",
    "proximo.title": "12-month goal: incorporate the company and sign the first contract",
    "proximo.p1t": "Consolidate the company",
    "proximo.p1d": "Incorporate AtomIA with the legal, administrative and infrastructure structure to operate.",
    "proximo.p2t": "Strengthen the team",
    "proximo.p2d": "Reinforce commercial and management capabilities.",
    "proximo.p3t": "Trade missions",
    "proximo.p3d": "Visit at least 7 plants: Argentina, Brazil, Romania and others. Attend top-level scientific events.",
